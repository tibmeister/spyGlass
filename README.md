...
| --- | :---: |
| spyGlass_am | [![Docker Automated build](https://img.shields.io/docker/automated/tibmeister/spyglass_am.svg?style=plastic)](https://hub.docker.com/r/tibmeister/spyglass_am/)[![Docker Build Status](https://img.shields.io/docker/build/tibmeister/spyglass_am.svg?style=plastic)](https://hub.docker.com/r/tibmeister/spyglass_am/)[![Docker Pulls](https://img.shields.io/docker/pulls/tibmeister/spyglass_am.svg?style=plastic)](https://hub.docker.com/r/tibmeister/spyglass_am/) |
| spyGlass_prometheus | [![Docker Automated build](https://img.shields.io/docker/automated/tibmeister/spyglass_am.svg?style=plastic)](https://hub.docker.com/r/tibmeister/spyglass_prometheus/)[![Docker Build Status](https://img.shields.io/docker/build/tibmeister/spyglass_am.svg?style=plastic)](https://hub.docker.com/r/tibmeister/spyglass_prometheus/)[![Docker Pulls](https://img.shields.io/docker/pulls/tibmeister/spyglass_am.svg?style=plastic)](https://hub.docker.com/r/tibmeister/spyglass_prometheus/) |
| spyGlass_grafana | [![Docker Automated build](https://img.shields.io/docker/automated/tibmeister/spyglass_am.svg?style=plastic)](https://hub.docker.com/r/tibmeister/spyglass_grafana/)[![Docker Build Status](https://img.shields.io/docker/build/tibmeister/spyglass_am.svg?style=plastic)](https://hub.docker.com/r/tibmeister/spyglass_grafana/)[![Docker Pulls](https://img.shields.io/docker/pulls/tibmeister/spyglass_am.svg?style=plastic)](https://hub.docker.com/r/tibmeister/spyglass_grafana/) |
| spyGlass-node-exporter | [![Docker Automated build](https://img.shields.io/docker/automated/tibmeister/spyglass_am.svg?style=plastic)](https://hub.docker.com/r/tibmeister/spyglass-node-exporter/)[![Docker Build Status](https://img.shields.io/docker/build/tibmeister/spyglass_am.svg?style=plastic)](https://hub.docker.com/r/tibmeister/spyglass-node-exporter/)[![Docker Pulls](https://img.shields.io/docker/pulls/tibmeister/spyglass_am.svg?style=plastic)](https://hub.docker.com/r/tibmeister/spyglass-node-exporter/) |


## Introduction

spyGlass is good starting point for using [Prometheus](https://prometheus.io/), 
[Grafana](http://grafana.org/), 
[cAdvisor](https://github.com/google/cadvisor), 
[Node Exporter](https://github.com/prometheus/node_exporter), 
[Alert Manager](https://github.com/prometheus/alertmanager)
and [Unsee](https://github.com/cloudflare/unsee) in a Docker Swarm stack that can easily be run at home, or anywhere.
...
```bash
$ https://github.com/tibmeister/spyGlass.git
$ cd spyGlass
...
spyGlass Grafana is preconfigured with two dashboards and Prometheus as the default data source:
...
The spyGlass Prometheus comes with the following alert rules:
...
[swarm_node](https://github.com/tibmeister/blob/master/prometheus/rules/swarm_node.rules) 
and [swarm_task](https://github.com/tibmeister/blob/master/prometheus/rules/swarm_task.rules) 
...
You can extend spyGlass with special-purpose exporters for services like MongoDB, PostgreSQL, Kafka, 
...
The spyGlass project is meant as a starting point in developing your own monitoring solution. Before running this 
...
spyGlass comes with built-in [Weave Cloud](https://www.weave.works/product/cloud/) integration, 
